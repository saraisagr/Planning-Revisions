# Banque d'idées de posts — Léna | Business et Liberté
...
|---|---|---|---|
| 9 | 3 outils gratuits pour lancer ton business digital cette semaine | Tuto | Carrousel |
| 10 | Non, tu n'as pas besoin de 10k abonnés pour vendre | Idée reçue à casser | Reel voix off |
| 11 | Comment je structure mon contenu sans y passer mes journées | Tuto / coulisses | Carrousel |
| 12 | La question qu'on me pose tout le temps : "par où commencer ?" | Question fréquente | Reel voix off |
| 13 | Ce que l'IA change vraiment dans le marketing digital en 2026 | Tendance niche | Carrousel |
| 14 | 3 stratégies marketing que j'ai testées et qui n'ont pas marché | Coulisses / idée reçue | Reel voix off |
| 15 | Le plan simple pour structurer une offre digitale de zéro | Tuto | Carrousel |

## Pilier 3 — Revenus Digitaux (20%)

| # | Titre accrocheur | Angle | Format |
|---|---|---|---|
| 16 | C'est quoi l'affiliation, expliqué en 60 secondes | Tuto | Reel voix off |
| 17 | 5 types de produits digitaux qu'on peut créer sans être experte | Tuto | Carrousel |
| 18 | L'idée reçue qui bloque le plus de femmes : "il faut être experte pour vendre" | Idée reçue à casser | Reel voix off |
| 19 | Comment je choisis les produits que je recommande | Coulisses | Carrousel |
| 20 | Est-ce que l'affiliation rapporte vraiment ? | Question fréquente | Reel voix off |
| 21 | Revenu actif vs revenu passif : ce qu'on ne te dit pas | Idée reçue à casser | Carrousel |

## Pilier 4 — Confiance & Liberté (20%)

| # | Titre accrocheur | Angle | Format |
|---|---|---|---|
| 22 | Le vrai frein n'est pas le manque de compétences | Idée reçue à casser | Reel voix off |
| 23 | Construire à son rythme : ce que ça veut dire concrètement | Tuto / mindset | Carrousel |
| 24 | Pourquoi se comparer aux "success stories" te fait du mal | Idée reçue à casser | Reel voix off |
| 25 | 3 signes que tu es prête à te lancer (même sans tout savoir) | Tuto / checklist | Carrousel |
...
## Source de l'actu (idée n°30)

- [Les tendances des réseaux sociaux à suivre en 2026](https://swello.com/fr/blog/tendances-reseaux-sociaux-2026/) — l'IA devient pilier central des stratégies social media, Meta prévoit d'automatiser entièrement ses publicités d'ici fin 2026.
